...
public class RequestAcceptedListAdapter extends ArrayAdapter<Order> {

    private Context context;
    private int resourse;

    public RequestAcceptedListAdapter(Context context, int resource, List<Order> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView priceView = (TextView) convertView.findViewById(R.id.priceAccepted);
        TextView pointAView = (TextView) convertView.findViewById(R.id.pointAAccepted);
        TextView pointBView = (TextView) convertView.findViewById(R.id.pointBAccepted);
        Button button = (Button) convertView.findViewById(R.id.finishAccepted);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View mview) {
                ...
                Single<String> result = apiService.finishRequest(id);
                result.subscribeOn(Schedulers.io())
                        ...
                        .subscribe(new SingleObserver<String>() {
                            ...
                            public void onSuccess(String result) {
                                ...
                                if(context instanceof AcceptedRequestsActivity){
                                    ((AcceptedRequestsActivity) context).yourDesiredMethod();
                                }
                            }
                            @Override
